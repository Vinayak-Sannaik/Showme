...
const Skills = () => {
    const skills = [
      ...
      { name: "Tailwind CSS", icon: "https://cdn-icons-png.flaticon.com/512/5968/5968705.png" },
      { name: "Webpack", icon: "https://cdn-icons-png.flaticon.com/512/919/919851.png" },
      // { name: "Git", icon: "https://cdn-icons-png.flaticon.com/512/733/733553.png" },
      ...
      { name: "GraphQL", icon: "https://cdn-icons-png.flaticon.com/512/919/919851.png" },
