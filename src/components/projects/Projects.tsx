const projects = [
  {
    name: "Project One",
    image: "path/to/project-one-image.png", // Add the path to the project image
    liveLink: "https://example.com/project-one",
    githubLink: "https://github.com/username/project-one",
  },
  {
    name: "Project Two",
    image: "path/to/project-two-image.png", // Add the path to the project image
    liveLink: "https://example.com/project-two",
    githubLink: "https://github.com/username/project-two",
  },
  {
    name: "Project Three",
    image: "path/to/project-three-image.png", // Add the path to the project image
        ...
        {projects.map((project, index) => (
          <div className="project-item" key={index}>
            ...
            <div className="project-buttons">
              <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="button">View Live</a>
